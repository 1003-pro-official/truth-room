# 박신입 진술서 (2026-07-30 오전 청취)

입사 3개월 차 박신입입니다. 솔직히 너무 무섭고 혼란스럽습니다. 저녁에 마라탕을 먹어서 배가 아팠고, **처음에는 11시부터 계속 3층 남자 화장실에 있었다**고 말했습니다. 사실… 불안해서 서버실 쪽을 몰래 보러 간 적이 있습니다. 문 근처에서 타이핑 소리 같은 게 들렸고, 누군가 더 있는 것 같았습니다. 손이 떨려서 동료 윤사원에게 슬랙으로 짧게 알렸는데, 화장실 알리바이랑 안 맞는 거 압니다. 죄송합니다. 거짓말을 하려던 게 아니라 혼날까 봐 줄였습니다. 다시 진술할 기회를 주셔서 감사합니다. 그날 팀 분위기가 이상해서 호기심과 공포가 동시에 있었습니다.
...
덧붙이면, 라운지 쪽에 불이 켜져 있는 걸 본 것도 기억납니다. 누가 있었는지는 못 봤습니다. 그때는 그냥 누가 야근하나 보다 했고, 지금 와서 생각하니 이상합니다.

제 계정으로는 학습 노드에 붙을 수도 없고, 서버실 문도 혼자서는 못 엽니다. 그날 문이 열려 있어서 들어간 겁니다. 이 부분은 출입 로그를 보시면 확인되실 겁니다.
