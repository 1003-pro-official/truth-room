...
서버실 랙 후면 콘솔 포트에 최근 접속 흔적이 남아 있으나 물리 매체 연결 흔적은 확인되지 않았다. 반출 경로는 물리 매체보다 네트워크일 가능성이 높다고 판단한다.

3층 라운지 AP 와 서버실 사이 구간의 스위치 포트 카운터를 별도 확보했다. 사건 창 전후 대역폭 이상 여부는 네트워크 로그와 대조해 판단할 것을 권고한다.
