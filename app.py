...
def _render_howto_body() -> None:
    ...
    steps = [
        (
            "01 용의자 선택",
            "「심문」·「최종 지목」 탭의 셀렉트 박스로 대상을 고릅니다. "
            "초상은 현재 대상 표시용이며, 우측 하단 「프로필」은 조회용입니다.",
        ),
        (
            "02 심문",
            "「심문」 탭에서 셀렉트로 심문 대상을 고른 뒤 질문을 입력하고 Enter로 전송합니다. "
        ...
        (
            "04 최종 지목",
            "「최종 지목」에서 셀렉트로 용의자 1명을 고르고, 인벤토리 증거 정확히 2장을 조합해 지목합니다. "
            "오답이면 수사 권한(♥)이 감소합니다.",
        ),
        (
            "05 Golden Route",
